...
![Tela principal]({{ site.baseurl }}{% link /files/2015/11/menu.png %})\\
*Tela principal*

![No jogo]({{ site.baseurl }}{% link /files/2015/11/game.png %})\\
*No jogo*

Se você for executar pra ver, lembre que só vai funcionar no linux e com o
Python 3 :P
