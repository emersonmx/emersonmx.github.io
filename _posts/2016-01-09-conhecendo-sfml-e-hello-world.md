...
}}{% post_url 2015-12-30-coisas-inuteis-para-2016 %}){:target="_blank"}, eu resolvi fazer algo de
...
SFML](http://www.sfml-dev.org/faq.php){:target="_blank"} para você ler antes
...
biblioteca](http://www.sfml-dev.org/faq.php#grl-learn){:target="_blank"}. E
mais uma vez, isso é só uma recomendação :)

[Anteriormente eu já postei um "Relou Uôrdi"]({{ site.baseurl
}}{% post_url 2015-11-06-um-relou-uordi-com-sfml-e-cmake %}){:target="_blank"}, mas
...
](http://www.sfml-dev.org/){:target="_blank"}(SFML) é uma biblioteca escrita em
...
outras](http://www.sfml-dev.org/download/bindings.php){:target="_blank"}.

-- Oxi, mas num é muito mió a [SDL](http://libsdl.org/){:target="_blank"} não?

Foda-se a SDL :)\\
[SFML é uma SDL orientada a
objetos](http://www.sfml-dev.org/faq.php#grl-whatis){:target="_blank"} e é
...
SFML](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1Window.php#ac30eb6ea5f5594204944d09d4bd69a97){:target="_blank"} :)
...
C++](http://www.sfml-dev.org/faq.php#prog-raii){:target="_blank"} (Rai aprova)
:lol:
...
C++](http://www.amazon.com.br/Effective-Modern-Specific-Ways-Improve/dp/1491903996){:target="_blank"}.
...
Started](http://www.sfml-dev.org/tutorials/2.3/#getting-started){:target="_blank"} explicando
como configurar a SFML para as IDEs mais comuns. Se der algum erro de
compilação, tem no [faq maroto da
SFML](http://www.sfml-dev.org/faq.php#trouble){:target="_blank"} como corrigir.
...
[FAQ](http://www.sfml-dev.org/faq.php){:target="_blank"} e acabou caindo na
parte de [tutorial](http://www.sfml-dev.org/tutorials/2.3/){:target="_blank"},
pode ser que você tenha encontrado a butija que tem escondida no [Wiki do
repositório do GitHub](https://github.com/SFML/SFML/wiki){:target="_blank"}. Lá
