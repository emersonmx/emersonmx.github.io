...
xrange]({{ site.baseurl }}{% post_url 2013-11-29-range-ou-xrange %}){:target="_blank"}.
...
## Referência
1. [https://wiki.python.org/moin/Generators](https://wiki.python.org/moin/Generators){:target="_blank"}
