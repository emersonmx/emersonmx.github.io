...
SFML. O módulo
_[Graphics](http://www.sfml-dev.org/documentation/2.3.2/group__graphics.php){:target="_blank"}_, em
específico a classe
...
_[Drawable](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1Drawable.php){:target="_blank"}_.
...
Então créa! De um
_[VertexArray](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1VertexArray.php){:target="_blank"}_ até
...
_[CircleShape](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1CircleShape.php){:target="_blank"}_,
_[ConvexShape](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1ConvexShape.php){:target="_blank"}_,
_[RectangleShape](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1RectangleShape.php){:target="_blank"}_,
_[Sprite](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1Sprite.php){:target="_blank"}_,
_[Text](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1Text.php){:target="_blank"}_,
_[VertexArray](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1VertexArray.php){:target="_blank"}_,
_[View](http://www.sfml-dev.org/documentation/2.3.2/classsf_1_1View.php){:target="_blank"}_, etc.
